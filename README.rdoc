...
# new idea, call oracle  
#
# degrees_c: oracle.call(temperatures) => returns (and thus you can safely display)


# new programming language ideas - my pseudo code
#
# antani: # program name
# 
# antani: (comments)
...
# antani => 
#
# based on ruby and coffeescript, running both ruby programs with gem and npm altogether, js is transpiled trough opal, opal native "wrapper" libraries are preferred, js libraries are 150% fine too 
#
# ruby is purely functional
# #
# #  check out repo makevoid/faucet, which contains how to use ruby as javascript, in a more functional way basicallyy using ruby blocks (procs) with the new syntax, and require_relative used like require.js 
# # 
# # TODO: finish, i moved to:
# # 
# # makevoid/s3play_v2
# # makevoid/uol2
#
